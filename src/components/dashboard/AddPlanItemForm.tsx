  ...
  if (!open) {
    return (
      <Button
        variant="outline"
        size="sm"
        className="rounded-full text-sm font-medium h-10 px-4 border-primary/40 text-primary hover:bg-primary/10 hover:text-primary focus-visible:ring-2 focus-visible:ring-ring"
