...
export const GuidePDF = () => (
  <Document title="What Every Realtor Should Know About Business Credit" author="Jessie Hunter" subject="Business Credit for Real Estate Professionals">
    ...
    <Page size="LETTER" style={s.page}>
      ...
      {[
        { label: 'Introduction: Congratulations on Your Recent Closing', page: '5', isChapter: true },
        { label: '    The Wake-Up Call', page: '', isChapter: false },
        { label: 'Chapter 1: My Story—The $8,000 Mistake', page: '8', isChapter: true },
        { label: '    The Wake-Up Call', page: '', isChapter: false },
        { label: '    The Mistakes I Made', page: '', isChapter: false },
        { label: '    What I Wish I\'d Known', page: '', isChapter: false },
        { label: 'Chapter 2: What Business Credit Actually Is', page: '16', isChapter: true },
        ...
        { label: 'Chapter 3: The True Cost of Using Personal Credit', page: '22', isChapter: true },
        ...
        { label: 'Chapter 4: Common Questions & Objections', page: '26', isChapter: true },
        ...
        { label: 'Chapter 5: The Seven-Step Process', page: '30', isChapter: true },
        ...
        { label: 'Chapter 6: The Emotional Journey', page: '35', isChapter: true },
        ...
        { label: 'Chapter 7: Why You Need Professional Guidance', page: '38', isChapter: true },
        ...
        { label: 'Chapter 8: Success Stories from Fellow Realtors', page: '41', isChapter: true },
        { label: 'Chapter 9: What\'s Next—Advanced Strategies', page: '44', isChapter: true },
        { label: 'Conclusion: Your Next Steps', page: '47', isChapter: true },
        { label: 'Resources & Additional Information', page: '54', isChapter: true },
      ].map((entry, i) => (
