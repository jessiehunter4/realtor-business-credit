      ...
      <div className="container mx-auto px-4 py-16 md:py-28 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="/get_started" className="inline-flex items-center justify-center gap-2 rounded-md border-2 border-white/30 text-white text-lg px-8 py-4 font-medium hover:bg-white/10 transition-colors">
