      ...
      <div className="container mx-auto px-4 py-16 md:py-28 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href={guideLink} className="inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground text-lg px-8 py-4 font-medium hover:bg-primary/90 transition-colors">
